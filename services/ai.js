...
function answer(question) {
  ...
  // Navigation intent detection  MUST run before topic matching
  // Catches: "how do i go to X", "how can i go to X", "where is X", "how do i find X", "how do i open X"
  const navIntent = [
    'how do i go to', 'how can i go to', 'how to go to',
    'how do i get to', 'how can i get to', 'how to get to',
    'how do i navigate', 'how do i find', 'how do i open',
    'where is', 'where can i find', 'where do i',
    'how do i access', 'take me to', 'i want to go to',
    'i want to open', 'i want to find', 'show me how to get'
  ];
